...
class PdfApi {
  static Future<File> generateAcNameStatement(
    ...
    StatementGenerator statementGenerator = StatementGenerator();
    List<Map<String, dynamic>> data = await statementGenerator
          ...
          return <pw.Widget>[
            pw.Header(
              ...
              child: pw.Row(
                ...
                children: <pw.Widget>[
                  pw.Text(
                      'Interest Statment for FY: ${year - 1} -  $year (Holding)',
                      textScaleFactor: 2),
                ],
              ),
            ),
  ...
  static Future<File> generateAcNameStatementClosed(
      String accHoldername, int year) async {
    String fyEn = '${year - 1}-04-01';
    String fySt = '$year-03-31';
    ...
    StatementGenerator statementGenerator = StatementGenerator();
    List<Map<String, dynamic>> data = await statementGenerator
        .getFDsByAccountHolderClosed(accHoldername, fyEn, fySt);
          ...
          return <pw.Widget>[
            pw.Header(
              ...
              child: pw.Row(
                ...
                children: <pw.Widget>[
                  pw.Text(
                      'Interest Statment for FY: ${year - 1} -  $year (Closed)',
                      textScaleFactor: 2),
                ],
              ),
            ),
  ...
  static Future<File> generateBankStatement(
    ...
    List<Map<String, dynamic>> data =
        await statementGenerator.getFDsByBankNumber(bankAccNumber, fyEn, fySt);
    final pdf = pw.Document();
    pdf.addPage(
      pw.MultiPage(
        // orientation: pw.PageOrientation.landscape,
  ...
  static Future<File> generateBankStatementClosed(
      String bankAccNumber, int year) async {
    String fyEn = '${year - 1}-04-01';
    String fySt = '$year-03-31';
    StatementGenerator statementGenerator = StatementGenerator();
    List<Map<String, dynamic>> data = await statementGenerator
        .getFDsByBankNumberClosed(bankAccNumber, fyEn, fySt);
    final pdf = pw.Document();
    pdf.addPage(
      pw.MultiPage(
        // orientation: pw.PageOrientation.landscape,
